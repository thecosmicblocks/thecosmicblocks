    ...
    return (
        <>
            <div
                ...
                style={{'backgroundImage': 'url("/bg.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=1&amp;w=500")'}}>
                <div className="absolute top-0 right-0 bottom-0 left-0 bg-[#37474B] opacity-90"></div>
                ...
                <div className="z-50 flex flex-col justify-center text-white w-full h-screen gap-3">
                        ...
                        <div className="w-full max-w-xl mx-auto">
                            <div className="flex items-center border-b border-indigo-500 py-2">
                                <input
                                    ...
                                    type="text" placeholder="username@email.ext" aria-label="Full name"
                                ...
                                <Link
                                    ...
                                    type="button"
                                    href={`mailto:support@thecosmicblock.com`}>Subscribe
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 flex text-white mx-auto">
                        <a href="/#">
                            <svg fill="currentColor" className="cursor-pointer h-10 mr-2" viewBox="0 0 24 24"
                                 version="1.1"
                                 fillRule={'evenodd'}
                                 clipRule={'evenodd'}
